...
namespace DJResortWebsite.Controllers
{
    public class GuestsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,Email,ContactNo")] Guest guest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,Email,ContactNo")] Guest guest)
        {
            if (ModelState.IsValid)
            {
